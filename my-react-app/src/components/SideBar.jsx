...
const Sidebar = () => {
    ...
    return (
        <div className="flex flex-col h-screen w-2/12 overflow-auto p-8 bg-app-lightGray">
            ...
            <Link to="/">
                <p className="text-right text-sm font-bold leading-snug py-1.5 px-3 m-1">TO-DO LIST</p>
            </Link>
            <Link to="/map">
            ...
            <div className="mt-auto">
                <Link to="/about">  
                    <p className="text-right text-xs leading-snug py-1.5 px-3 m-1 opacity-50">ABOUT</p>
                </Link>
                {user && (
